	...
	foreach ana $analysis_components {
		...
		switch -exact -- $type {
			...
			#	puts $ss_file "ss_analysis $MOL $max_structures $resid_start $resid_stop $chain_id"
			  puts $ss_file "ss_analysis -molfile ${MOL}_rosetta_scoring_min_${bestN}.pdb -sel \"resid $resid_start to $resid_stop and chain $chain_id\" -avg 1 -output \"ss_${bestN}_${resid_start}_${resid_stop}\""
      	puts $ss_file "quit"
				close $ss_file
