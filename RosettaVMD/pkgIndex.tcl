# package ifneeded HelloWorld 1.0 [list source [file join $dir package_example.tcl]]
package ifneeded RosettaVMD 0.1 [list source [file join $dir rosetta_vmd.tcl]]
